...
const MainPage = () => {
  ...
  const updateDenominations = (updatedDenomination: Denomination) => {
    setDenominations(denominations.map((denomination: Denomination) => {
    ...
    <div className="container pb-5">
      <div className="row">
        <BalanceSheet
          ...
          onDenominationChange={(updatedDenomination: Denomination) => updateDenominations(updatedDenomination)}
        />
        <Operations
          denominations={denominations}
          onDenominationsChange={(denominations: Denomination[]) => setDenominations([...denominations])}
        />
      </div>
      <DenominationList
        denominations={denominations}
